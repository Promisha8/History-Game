...
var cards : [[Card]] = [
    [
        ...
        Card(correctLetter: ["A"], imageName: "И-3"),
        ...
        Card(correctLetter: ["A"], imageName: "АЁ-2"),
    ...
    [
        ...
        Card(correctLetter: ["Г"], imageName: "г-1"),
        Card(correctLetter: ["Д"], imageName: "д-1"),
        Card(correctLetter: ["Е"], imageName: "е-2"),
        Card(correctLetter: ["Ё"], imageName: "ё-3"),
        Card(correctLetter: ["Ж"], imageName: "ж-1"),
        Card(correctLetter: ["З"], imageName: "з-1"),
        Card(correctLetter: ["И"], imageName: "и-2"),
        Card(correctLetter: ["Й"], imageName: "и-1"),
        ...
        Card(correctLetter: ["АЁ"], imageName: "аё-1"),
